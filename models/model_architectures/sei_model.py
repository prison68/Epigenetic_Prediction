...
def criterion():
    """
    The criterion the models aims to minimize.
    """
    return nn.BCELoss()
...
def get_optimizer(lr):
    ...
    At a later time, we initialize the optimizer by also passing in the models
    parameters (`models.parameters()`). We cannot initialize the optimizer
    until the models has been initialized.
    """
